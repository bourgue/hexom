function ParamsWindow() {
  $("body").prepend('<div id="paramsWindow" class="window unselectable">' +
    ...
    '<li>' + '<div id="backColor"></div>' + '<input id="backgroundColor_ipt" type="color" onchange="ParamsWindow.prototype.backgroundColorChange(this.value);"/>' + '</li>' +
    '<li>' + '<div id="shadowColor"></div>' + '<input id="shadowColor_ipt" type="color" onchange="ParamsWindow.prototype.shadowColorChange(this.value);"/>' + '</li>' +
    '<li>' + '<div id="shadowSize"></div>' + '<input id="shadowSize_ipt" value="200" max="300" min="0" step="25" type="range" onchange="ParamsWindow.prototype.shadowSizeChange(this.value)"/>' + '</li>' +
    '<li>' + '<div id="hexaSize"></div>' + '<input id="hexaSize_ipt" value="1" max="2" min="0.4" step="0.2" type="range" onchange="ParamsWindow.prototype.hexaSizeChange(this.value)"/>' + '</li>' +
